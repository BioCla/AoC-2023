...
"Wait - I thought you were looking for the hot springs, weren't you?" You indicate that this definitely looks like hot springs to you.
...
"Hello!
What brings you to the hot springs today? Sorry they're not very hot right now; we're having a lava shortage at the moment."
...
int part1(std::string input_file_path)
{
  ...
  for (std::string row : document)
  {
    ...
    total += get_arrangements(row_string, -1, row_groups, cache);
  }
  return total;
}
